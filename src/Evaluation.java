public class Evaluation {
    ...
    // Game phase increments for pieces (index by piece code 0..11)
...
//middlegame heatmaps wo die jeweiligen Figuren sein sollten
    ...
    private static final int[][] mgTables = {
            mg_pawn,
            mg_knight,
            mg_bishop,
            mg_rook,
    ...
    private static final int [][] egTables = {
            eg_pawn,
            eg_knight,
            eg_bishop,
            eg_rook,
    ...
    private static int pieceCode(int pieceType, int color) {
    ...
    public static int [] evaluation(Piece[][] board, boolean isWhite) {
        ...
        for (int y = 0; y < 8; y++) {
            for (int x = 0; x < 8; x++) {
                ...
                int color = p.isWhite() ? WHITE : BLACK;
                int sq = y * 8 + x;
